...
$file_name = 'container_rect_list_pointer.cpp';
$file_name_new = 'container_rect_list_pointer_runNumber.cpp';
$changed_line = 16;
...
foreach $run_number (@run_number_case) {
    ...
    system("g++ -std=c++11 container_rect_list_pointer_runNumber.cpp -o container_rect_list_pointer_runNumber");
    system("./container_rect_list_pointer_runNumber");
